      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <a href={`tel:${config?.contact?.phone || '+96171500363'}`} className="flex items-center text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-primary-400">
      ...
      <div className="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
              ...
              <div className="ml-3 flex-1">
                ...
                {booking.paymentMethod === 'omt' && (
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      ...
                      <Button
                        href={`https://wa.me/${config?.contact?.whatsapp || '96171500363'}?text=Booking%20ID:%20${booking.booking_id}%20-%20Sending%20OMT%20receipt`}
                        variant="success"
                        size="lg"
                        className="w-full sm:w-auto"
                      >
                ...
                {booking.paymentMethod === 'whish-money' && (
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      ...
                      <Button
                        href={`https://wa.me/${config?.contact?.whatsapp || '96171500363'}?text=Booking%20ID:%20${booking.booking_id}%20-%20Sending%20Wish%20Money%20receipt`}
                        variant="success"
                        size="lg"
                        className="w-full sm:w-auto"
                      >
                ...
                {!['stripe', 'omt', 'whish-money'].includes(booking.paymentMethod) && (
                  <div className="space-y-3">
                    ...
                    <Button
                      href={`https://wa.me/${config?.contact?.whatsapp || '96171500363'}?text=Booking%20ID:%20${booking.booking_id}%20-%20Payment%20inquiry`}
                      variant="success"
                      size="lg"
                      className="w-full sm:w-auto"
                    >
          ...
          <div className="bg-green-50 dark:bg-green-900/20 border-2 border-green-400 dark:border-green-600 rounded-lg p-6 mt-8">
            <div className="flex items-start">
              ...
              <div className="ml-3 flex-1">
                ...
                <a
                  href={`https://wa.me/${config?.contact?.whatsapp || '96171500363'}?text=${encodeURIComponent(`Hi, I'd like to request a change to booking ${booking.booking_id}`)}`}
        ...
        <div className="bg-primary-50 dark:bg-primary-900/20 rounded-lg p-6 mt-8">
          ...
          <ul className="space-y-2 text-primary-800 dark:text-primary-300">
            <li>• For any changes, please contact us at {config?.contact?.phone || '+961-71-500-363'}</li>
          </ul>
        </div>
