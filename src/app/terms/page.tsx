            ...
            <div className="prose prose-slate max-w-none space-y-6 text-charcoal-500 dark:text-gray-300">
              ...
              <section>
                ...
                <div className="bg-cream-50 dark:bg-gray-700 rounded-lg p-4 dark:text-gray-300">
                  ...
                  <p><strong>WhatsApp:</strong> <a href="https://wa.me/96171500363" className="text-primary-600 dark:text-primary-400 hover:underline" target="_blank" rel="noopener noreferrer">+961-71-500-363</a></p>
