...
export const metadata: Metadata = generateMetadata({
  title: 'Wedding Cars in Lebanon with Chauffeur',
  description:
    'Wedding car rental in Lebanon: bridal cars, classic & convertible cars, and full wedding convoys with suited chauffeurs. Serving every ceremony and venue in Beirut, Jounieh, Byblos, Broummana, Faraya, the Chouf & all Lebanon.',
  path: '/',
})
