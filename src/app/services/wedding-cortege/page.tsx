...
export const metadata: Metadata = generateSeoMetadata({
  title: 'Wedding Cortège in Lebanon - Full Wedding Car Convoy',
  description: 'Book a full wedding cortège in Lebanon: decorated bridal car, family cars, and groomsmen vehicles moving as one convoy with suited chauffeurs. Route planning, zaffe timing, and church arrivals handled across all Lebanon.',
  path: '/services/wedding-cortege',
})

export default function WeddingCortegePage() {
  const faqs = [
    {
      question: "What exactly is included in a wedding cortège booking?",
    ...
    {
      question: "How many cars can the cortège include?",
    ...
    },
    {
      ...
      answer: "Every chauffeur gets the route in advance, drives in an agreed order with set spacing, and stays connected on a group channel. If a light splits the convoy, the lead car adjusts pace so the cortège regroups before the arrival."
    },
    {
    ...
    {
      question: "Can the cortège do the traditional honking celebration?",
        ...
        <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <p className="script-accent text-3xl text-primary-100 mb-4">el cortège jeye…</p>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                The Wedding Cortège
              </h1>
              <p className="text-xl md:text-2xl text-white mb-8">
                Your whole wedding moving as one — from the family home to the church to the venue
              </p>
              <Link
                href="/booking"
          ...
          <section className="mb-16">
            ...
            <div className="max-w-none">
              <p className="text-black dark:text-gray-300 text-lg leading-relaxed mb-4">
                In Lebanon, the wedding doesn&apos;t start at the church — it starts the moment the cortège pulls up at the family
                home. The decorated lead car, the convoy of family and friends behind it, the horns, the zaghrouta from the
              ...
              <p className="text-black dark:text-gray-300 text-lg leading-relaxed mb-4">
                ...
                Before the day, we scout your route — home, church, photo stop, venue — and build a timeline around your
              ...
              <p className="text-black dark:text-gray-300 text-lg leading-relaxed">
                We run cortèges everywhere in Lebanon: through Beirut&apos;s streets to <Link href="/routes/wedding-cars-beirut" className="underline hover:text-primary-600">Achrafieh and downtown churches</Link>,
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-warm-200 dark:border-gray-700">
                ...
                <p className="text-warm-600 dark:text-gray-400 leading-relaxed">
                  We drive your route in advance, plan for traffic and roadworks, and build buffers around the church slot. You will not be late.
                </p>
              </div>
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-warm-700 dark:text-gray-300">
              <div className="flex justify-between items-center py-2 border-b border-warm-200 dark:border-gray-700">
                <span>Bridal car only (6h ceremony package)</span>
                <span className="font-semibold text-primary-600 dark:text-primary-400">from $150</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-warm-200 dark:border-gray-700">
                <span>Bridal car + 2 family cars</span>
                <span className="font-semibold text-primary-600 dark:text-primary-400">from $400</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-warm-200 dark:border-gray-700">
                <span>Full cortège, 5 cars (10h celebration)</span>
                <span className="font-semibold text-primary-600 dark:text-primary-400">from $750</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-warm-200 dark:border-gray-700">
                <span>Grand cortège, 8+ cars, full day</span>
                <span className="font-semibold text-primary-600 dark:text-primary-400">custom quote</span>
              </div>
            </div>
            <p className="text-sm text-warm-600 dark:text-gray-400 mt-4">
              *Indicative starting prices — final quote depends on cars chosen, region, and hours. See the <Link href="/#fleet" className="underline hover:text-primary-600">wedding fleet</Link> for per-car pricing, or request a quote for your exact plan.
            </p>
          </section>
        </div>
